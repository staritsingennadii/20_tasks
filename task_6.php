    ...
    <body class="mod-bg-1 mod-nav-link ">
        <main id="js-page-content" role="main" class="page-content">
            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="<?=$contact['id'];?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?=$contact['filter_tags'];?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?=$contact['status'];?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/avatars/<?=$contact['photo'];?>'); background-size: cover;"></span>
                                </span>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <a href="mailto:<?=$contact['mail'];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?=$contact['mail'];?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?=$contact['address'];?></address>
