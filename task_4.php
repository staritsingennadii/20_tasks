                        ...
                        <div class="panel-content">
                            ...
                            <div id="js-lightgallery">
                                ...
                                <?foreach($gallery as $img) {?>
                                    <a class="" href="<?= $img["src"]; ?>">
                                        <img class="img-responsive" src="<?= $img["thumb"]; ?>" alt="<?= $img["alt"]; ?>">
                                    </a>
                                <? } ?>
